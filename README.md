...
- **Worked example** — [`pascalorg/plugin-trees`](https://github.com/Unity-Agriculture/plugin-trees): a standalone plugin with procedural trees, flowers, grass, and a presets panel. Clone it as a starting point.
